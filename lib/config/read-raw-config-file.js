...
/**
 * Used to maintain back compatibility with older versions of the .pbrocks-env.json
 * file. Returns an object in the shape of the currently expected .pbrocks-env.json
 * version.
 *
